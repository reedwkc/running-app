...
export const WHY = {
  ...
  vo2max:{why:'Raises your aerobic ceiling (VO2max), which gives your threshold pace more room to climb over time.',
        tip:'Hard-but-repeatable, not an all-out sprint. HR lags behind effort for the first 60-90 seconds of each rep - normal, don\'t chase it by starting faster than prescribed. It should also climb across the whole set, not just within one rep - the HR gauge above marks a lower opening-rep target building to a higher one by your last 1-2 reps; treating that final number as a flat target from rep one is how you burn out early. Check pace/HR after the first two reps - fading by the last two means you started too fast. Aim for even pace/effort across all reps and let HR follow its own natural build.'},
