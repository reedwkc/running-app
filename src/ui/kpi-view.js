...
export async function renderKPIPage(){
  ...
  // What sessions had LEFT (coach/session-ceiling.js) - the one signal here that speaks to
  // the ceiling rather than the cost of a pace.
  {
    let probeHist = [];
    ...
    html += '<div class="card" style="margin-top:12px;">'+
      ...
      '<div class="note" style="margin-top:8px; border-top:none; padding-top:0;">Every fourth threshold session ends with one free rep, run at the fastest pace you could still have repeated. Read off your last work rep automatically - nothing to fill in. A fatigued maximum rather than a time trial, but a repeatable one, every few weeks instead of every few months.</div></div>';
  }
  el.innerHTML = html;
}
