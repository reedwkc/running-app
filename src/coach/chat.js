...
export async function autoCoachMessage(kind, data){
  ...
  if(kind==='weeklysummary'){
    ...
    const qualifiesTier2 = (isThresholdOrVo2 || isGoalPaceLong) && data.obj.stravaImport && data.obj.stravaImport.lapsReliable && !data.eq;
    const qualifiesTier3 = (isThresholdOrVo2 || isGoalPaceLong) && data.obj.performedMode==='treadmill' && (data.day.type==='vo2max' || data.day.type==='long' || data.obj.treadmillLTSpeed) && data.obj.teAero;
